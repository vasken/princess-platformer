...
const ALLOWED = new Set([
  ...
  "editor.html",
  "levels.js",
  "assets/princess-main.png",
  "assets/princess-pigtails.png",
  "assets/isometric_forest_puzzle_assets_sheet_transparent.png",
]);
    ...
    if (req.method === "POST" && pathname === "/api/save-levels") {
      ...
      if (!body.includes("window.LEVELS")) {
        return send(
          res,
          400,
          '{"ok":false,"error":"payload missing window.LEVELS"}',
